...
/*   Updated: 2022/03/16 12:06:46 by fcatinau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap( std::string	name, int const hit, int const energy, int const attack) :
...
std::ostream	&operator<<(std::ostream &ostream, ClapTrap const &clap) {
	ostream << "ClapTrap:" << std::endl << "name: " << clap.getName() << std::endl << "hit : " << clap.getHit() << std::endl;
	ostream << "energy : " << clap.getEnergy() << std::endl << "attack : " << clap.getAttack() << std::endl;
	return ostream;
}
